 ...
 * @author bruno.sasse
 */
public class ExcluirCadastroAdm extends ExcluirCadastroPadrao {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ExcluirCadastroAdm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ExcluirCadastroAdm().setVisible(true);
            }
        });
    }
